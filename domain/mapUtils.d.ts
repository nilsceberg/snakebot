import { Coordinate, Position, SnakeInfo } from "./mamba/snakeInfos";
import { GameMap } from "./mamba/gameMap";
...
export function getTileAt(coordinate: Coordinate, map: GameMap): Tile;
...
export function isTileAvailableForMovementTo(coordinate: Coordinate, map: GameMap): boolean;
