 ...
 */
function getTileAt(coordinate, map, precomputed) {
 ...
 * result in death.
 */
function isTileAvailableForMovementTo(coordinate, map, precomputed) {
    const tile = getTileAt(coordinate, map, precomputed);
